...
REM
REM Generated by Vivado on Sun Nov 23 22:37:22 +0100 2025
...
echo "xvlog --incr --relax -L uvm -prj trafficLights_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj trafficLights_tb_vlog.prj -log xvlog.log
